...
UNITREE_MODEL_DIR = "/home/sii-humanoid/humanoid/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "/home/sii-humanoid/humanoid/unitree_ros"  # Replace with the actual path to your unitree_ros package
...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{UNITREE_ROS_DIR}/robots/g1_description/g1_29.urdf",
    ),
    # spawn=UnitreeUsdFileCfg(
